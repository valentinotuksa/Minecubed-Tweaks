...
public class InfectionsCommand extends Command {

    public InfectionsCommand(@NotNull String name) {
        super(name);
    }
    ...
    public boolean execute(@NotNull CommandSender commandSender, @NotNull String s, @NotNull String[] strings) {
        ...
        String infections = Diseases.playerDiseaseDataMap.get(player.getUniqueId()).getInfections().keySet().toString();
        commandSender.sendMessage(player.getName() + " has the following infections: " + infections);
